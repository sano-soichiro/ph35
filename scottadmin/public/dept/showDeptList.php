        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $dept->getDpLoc() ?></td>
                    <td>
                        <form action="/ph35/scottadmin/public/dept/prepareDeptEdit.php" method="post"><input type="hidden" id="editDeptId<?= $dept->getId() ?>" name="editDeptId" value="<?= $dept->getId() ?>"><button type="submit">編集</button></form>
                    </td>
                    <td>
                        <form action="/ph35/scottadmin/public/dept/confirmDeptDelete.php" method="post"><input type="hidden" id="deleteDeptId<?= $dept->getId() ?>" name="deleteDeptId" value="<?= $dept->getId() ?>"><button type="submit">削除</button></form>
                    </td>
                </tr>
                <?php
                        }
